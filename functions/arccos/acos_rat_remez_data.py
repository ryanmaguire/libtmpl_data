...
################################################################################
#   Purpose:                                                                   #
#       Computes the rational minimax coefficients for arc-cosine.             #
################################################################################
#   Author: Ryan Maguire                                                       #
...
# Compute the coefficients for the Taylor series.
coeffs = [acos.taylor(n) for n in range(1, 60)]

# Computes the Taylor series for (acos(x) - x) / x^3.
def acos_taylor(x_val):
    """
        Function:
            acos_taylor
        Purpose:
            Computes the Taylor series of (acos(x) - x) / x^3.
    """
...
(P, Q, err) = tmpld.remez.rat_remez(acos_taylor, 8, 8, -0.5, 0.5)
